    ...
    <div v-if=" isLogin && cartList.length > 0">
      ...
      <div class="footer-fixed">
        ...
        <div class="all-total">
          ...
          <div v-if="!isEdit" @click="goPay" :class="{goPay: true, disabled: this.selCount === 0}">结算({{ selCount }})</div>
          <div v-else @click="handleDel" :class="{delete:true, disabled: this.selCount === 0}">删除</div>
        </div>
      </div>
    </div>
